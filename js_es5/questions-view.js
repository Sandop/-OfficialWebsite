...
(function () {
    ...
    $.ajax({
        ...
        success: function success(data) {
            var label_html = '<div class="news-view-tag"><a href="javascript:viod(0);">' + data.labelList[0].articleLabelName + '</a></div>' + '<div class="news-view-tag"><a href="javascript:viod(0);">' + data.labelList[1].articleLabelName + '</a></div>';
